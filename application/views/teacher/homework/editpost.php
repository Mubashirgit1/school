        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/homework/edit/'.$editpost['id']) ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="classwork" name="classwork" placeholder="" rows="5" placeholder="Enter Classwork..."><?php echo strip_tags($editpost['classwork'])  ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="homework" name="homework" placeholder="" rows="5" placeholder="Enter Homework..."><?php echo strip_tags($editpost['homework'])  ?></textarea>
                                        <span class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
