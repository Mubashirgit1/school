                ...
                <?php if (empty($list)) {
                    ...
                    foreach ($list as $data) {
                        ...
                        <tr>
                            ...
                            <td><?= $data['password'] ?></td>
                            <td><a href="<?= $data['link']; ?>" class="btn btn-sm btn-primary">Join Now</a></td>

                            <td class="mailbox-date pull-right">
                                <a href="<?php echo base_url(); ?>teacher/onlineclass/edit/<?php echo $data['id'] ?>"
                                   class="btn btn-default btn-xs" data-toggle="tooltip"
                                   title="<?php echo $this->lang->line('edit'); ?>">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?php echo base_url(); ?>teacher/onlineclass/delete/<?php echo $data['id'] ?>"
                                   class="btn btn-default btn-xs" data-toggle="tooltip"
