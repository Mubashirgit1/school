        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/onlineclass/edit/'.$editpost['id']) ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="content_title" name="content_title" placeholder="" required  type="text" class="form-control"  value="<?php echo $editpost['title'] ?>" />
                                <input id="teacher_id" name="teacher_id" placeholder="" type="hidden" class="form-control"  value="<?php echo $editpost['teacher_id'] ?>" />
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control"  name="description" value="<?php echo $editpost['description'] ?>" placeholder="Enter Description..."/>
