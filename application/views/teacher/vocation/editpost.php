        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/vocations/edit/'.$editpost['id']) ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="content_title" name="content_title" placeholder="" type="text"  required class="form-control"  value="<?php echo $editpost['title'] ?>" />
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="vocation" name="vocation" required  placeholder="" rows="5" placeholder="Enter vocation..."><?php echo strip_tags($editpost['vocations'])  ?></textarea>
