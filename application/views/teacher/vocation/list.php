            ...
            <tbody>
                <?php if (empty($list)) {
                    ...
                    foreach ($list as $data) {   
                        ...
                        <?php echo $data['title'] ?>
                            ...
                            <td class="mailbox-name">
                                    ...
                                    if ($data['vocations'] == "") {
                                        ...
                                        ?>
                                        <p class="text text-info"><p><?php echo $data['vocations']; ?></p></p>
                                        <?php
                                    }
                                    ?>
                        ...
                        <a href="<?php echo base_url(); ?>teacher/vocations/edit/<?php echo $data['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                <i class="fa fa-pencil"></i>
                            </a>                                                  
                                <a href="<?php echo base_url(); ?>teacher/vocations/delete/<?php echo $data['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
