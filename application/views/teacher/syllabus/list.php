                                        ...
                                        foreach ($list as $data) {   
                                            ...
                                            <?php echo $data['title'] ?>
                                                ...
                                                <td class="mailbox-name">
                                                        ...
                                                        if ($data['syllabus'] == "") {
                                                            ?>
                                                            <p class="text text-danger">No Syllabus </p>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <p class="text text-info"><p><?php echo $data['syllabus']; ?></p></p>
                                                            <?php
                                                        }
                                                        ?>
                                             ...
                                             <td class="mailbox-name">  <a target="blank"     href="<?php echo base_url(); ?><?php echo $data['file'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>teacher/syllabus/edit/<?php echo $data['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </a>                                                  
                                                    <a href="<?php echo base_url(); ?>teacher/syllabus/delete/<?php echo $data['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
