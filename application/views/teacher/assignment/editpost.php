        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/assignment/edit/'.$editpost['id']) ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="teacher_id" name="teacher_id" placeholder="" type="hidden" class="form-control"  required  value="<?php echo $editpost['teacher_id'] ?>" />
