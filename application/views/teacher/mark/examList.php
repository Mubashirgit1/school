                                        ...
                                        foreach ($examlist as $key => $exam) { ?>
                                            <tr>
                                                <td class="mailbox-name">
                                                    ...
                                                    <a href="<?= site_url('teacher/mark/examclass')?>?exam_id=<?php echo $exam['id'] ?>" data-toggle="popover" id="<?php echo $exam['id'] ?>" class="detail_popover exams_all" <?= $exam['id'] == $exam_id?'style="color:#0084B4;font-size:15px;"':'style="color:#000;font-size:12px;"' ?> ><?php echo $exam['name'] ?></a>
                                        ...
                                        <?php foreach ($class_sections as $key => $class_section): ?>
                                            <tr>
                                                ...
                                                <td  class="text pull-right">
                                                    <a href="<?= site_url('teacher/mark/index1')?>?class_id=<?php echo $class_section['class_id'] ?>&section_id=<?php echo $class_section['section_id'] ?>" class="mark_register_view" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>"  data-examid="<?php echo $exam_id; ?>" data-original-title="<?php echo $this->lang->line('view_detail'); ?>" data-sectionid="<?php echo $class_section['section_id'] ?>" data-classid="<?php echo $class_section['class_id'] ?>" data-classname="<?php echo $class_section['class']['class'] ?>"  data-sectionname="<?php echo $class_section['section']['section'] ?>">
                                                        <!-- <img style="max-width: 16px" src="<?php echo base_url(); ?>backend/images/view1.jpg" alt="view"/> -->
                                                        <i class="fa fa-print text-black"></i>
                                                    </a>
                                                    ...
                                                    <a href="<?= site_url('teacher/mark/create')?>?class_id=<?php echo $class_section['class_id'] ?>&section_id=<?php echo $class_section['section_id'] ?>"  class="mark_register_edit" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"  data-examid="<?php echo $exam_id; ?>" data-original-title="<?php echo $this->lang->line('view_detail'); ?>" data-sectionid="<?php echo $class_section['section_id'] ?>" data-classid="<?php echo $class_section['class_id'] ?>" data-classname="<?php echo $class_section['class']['class'] ?>"  data-sectionname="<?php echo $class_section['section']['section'] ?>">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.schedule_modal', function () {
        ...
        $.ajax({
            type: "post",
            url: base_url + "teacher/mark/getexamscheduledetail",
