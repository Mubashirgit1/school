            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">    <?php echo $examname; ?> / <?= $class ?> ( <?= $section ?>) </h3>
                        <div class="box-tools pull-right">
                        <a href="<?php echo site_url( 'teacher/mark/examclass?exam_id='.$exam_id ) ?>" class="btn btn-primary btn-sm">
...
if (isset($examSchedule)) {
    ?>
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"> <?php echo $this->lang->line('fill_mark'); ?></h3>
        ...
        <?php foreach ($examSchedule as $key => $student) {
            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="text" name="student[]" value="<?php echo $student['student_id'] ?>">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="checkbox">
                                                                        ...
                                                                        <label>
                                                                        <input type="checkbox" name="student_absent<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="ABS" <?php if ($exam_schedule['attendence'] == "ABS") echo "checked"; ?>>Abs</label>
                                                                    </div>
