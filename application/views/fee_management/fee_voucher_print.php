                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="fee_voucher_heading"
                                                     style="margin-bottom:0px; font-size:14px;margin-left: -40px;margin-top: -25px;">
                                                    <?= $bank_name ?><br>
                                                    <?= $bank_account_top ?>
                                                </div>
                                            ...
                                            if ($permission->expiry_date == 1) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($fee_voucher['other'] == 0) {
                                                        ...
                                                        <td>Expiry Date</td>
                                                        <td><?= date('d-M-y', strtotime($fee_voucher['expire_date'])); ?></td>                                        <?php } ?>
                                                </tr>
                                ...
                                <div class="fee_voucher_fee_details">
                                    <?php if ($permission->voucher_details == 1) { ?>
                                        <table class="table">
                                            ...
                                            $due_fee = $fee_voucher['monthly_fee'];
                                            if ($due_fee > 0): ?>
                                                <tr>
                                                    <td><?= date('M') ?> Fee</td>
                                                    <td class="amount"> <?= number_format($due_fee, 0, '', ',') ?></td>
                                                </tr>
                                            <?php endif ?>
                                            <?php if ($permission->fine_arrears == 0) { ?>
                                            ...
                                            <?php if ($fee_voucher['total_fee'] != 0): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="amount"> <?= number_format($fee_voucher['total_fee'] + $fee_voucher['arrears'] + $student_fine + $other_total) ?></td>
                                                </tr>
                                    ...
                                    <?php } ?>
                                    <?php if ($fee_voucher['total_fee'] != 0): ?>
                                        <?php if (!empty($fee_voucher['due_date'] && $student_fee_fine_type == 'per_day_fine_after_due_date' && $permission->other_voucher_fine == 1)): ?>
