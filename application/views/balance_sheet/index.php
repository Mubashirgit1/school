                        ...
                        <div class="box-body">
                            ...
                            <?php else: ?>
                                <div class="table-responsive">
                                    <table class="table     table-bordered  balance_sheet_table"  id="example" style="color:#666666;">                    <thead>
                                        <tr>
                                            ...
                                            if ($permission->student_balance_sheet == 1) {
                                                ...
                                                <th class="text-center"> <a style="color:#666666; " class="table_link"  href="<?= site_url('student/all_students') . "?gender=" ?>">
...
<!--       ////////////////////// discount/////////////-->
                                                <th class="width_for_balance_sheet_table text-center">  <a style="color:#666666;" class="table_link" href="<?= site_url( 'student/discount_report' ) ?>"> <?= number_format( $total['discount'] ) ?> </a> </th>
<!--   ////////////////////////  After Discount////////////////////-->
...
<!--     //////////////////////Total monthly DUE /////////////////////////////-->
                                                ...
                                                <a style="color:#666666;" class="table_link" href="<?= site_url( 'fee_management/classWiseReport' ) ?>">
                                                

                                                 <?=  number_format( $total_monthly_due   ) ?>
...
<!--     //////////////////////Total monthly Withdrawl /////////////////////////////-->
 ...
 <!--     //////////////////////Total Other Due Fee /////////////////////////////-->
                                                <th class="width_for_balance_sheet_table text-center">
                                                    <a style="color:#666666;" class="table_link" href="<?= site_url( "fee_management/other_fee_report?date_from=" . urlencode( "$month/01/{$year}" ) . "&date_to=" . urlencode( "{$month}/" . cal_days_in_month( CAL_GREGORIAN, $month, $year ) . "/{$year}" ) . "&search_type=pending&search_type_=student_wise&search=search_filter" ) ?>>">
                                                        <?= number_format(  $unpaid_students_other ) ?>
                                                    </a>
                                                </th>   
 <!--     //////////////////////Total Other Paid Fee /////////////////////////////-->
                                                <th class="width_for_balance_sheet_table text-center">
                                                    <a style="color:#666666;" class="table_link" href="<?= site_url( "fee_management/other_fee_report?date_from=" . urlencode( "$month/01/{$year}" ) . "&date_to=" . urlencode( "{$month}/" . cal_days_in_month( CAL_GREGORIAN, $month, $year ) . "/{$year}" ) . "&search_type=paid&search_type_=student_wise&search=search_filter" ) ?>">
 ...
 <!--     ////////////////////// Grand  Total /////////////////////////////-->
                                                <th class="width_for_balance_sheet_table text-center">
                                                    <a style="color:#666666;" href="<?= site_url( "fee_management/fee_reports?class_id=&section_id=&date_from=" . urlencode( "$month/01/{$year}" ) . "&date_to=" . urlencode( "{$month}/" . cal_days_in_month( CAL_GREGORIAN, $month, $year ) . "/{$year}" ) . "&search=search_filter" ) ?>" class="table_link">
                                                       <?php   $grand_total = floatval( $total['total_other_fee'] ) + floatval( $total['total_paid_arrears11']) + floatval( $total['total_paid_fee1'] + floatval($total['class_section_advance_fee'] )    )?>
...
<!--      //////////////////Monthly advance Fee//////////////////////-->
 ...
 <!--      //////////////////others due Fee//////////////////////-->
                                                    <td class="width_for_balance_sheet_table text-center" >
                                                    <?= ( $class_section['class_section_monthly_log'] !== false ? number_format( $class_section['class_section_monthly_log'][0]['total_other_due_fee'] ) : 0 ) ?>
                                                    </td>
 <!--      //////////////////others due Fee Paid//////////////////////-->
                                                    <td class="width_for_balance_sheet_table text-center    ">
                        ...
                        <div id="demo2" >
                            <div class="row">
                                <div class="col-xs-12 col-sm-5" style="width: 47%">
                                    <div class="box" style="margin:0px 0px 0px 7px">
                                                ...
                                                <div class="col-sm-2" style="width:19%;  " >
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table     table-bordered table-hover" cellspacing="0" width="100%">                          <thead>
                                                            ...
                                                            <tr>
                                                                <?php  
                                                                $total_others_paid = $total['total_other_fee'] -   $total['total_fine1'];
                                                                $others =  $total_others_paid > 0 ?  $total_others_paid : 0 ?>
                                                                <td colspan="2" class="text-center"><?=  number_format($others) ?></td>
                                                            </tr>
                                                            <tr>

                                                                <td colspan="2" class="text-center"><?=  number_format($total['class_section_advance_fee']) ?></td>
                                                            </tr>

                                                            <tr>
                                                                <?php $total_collection = $total['total_paid_fee1']+$total['total_paid_arrears11']  + $total_others_paid + $total['class_section_advance_fee'] +$total['total_other_fee'] ?>
