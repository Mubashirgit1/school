...
<div class="content-wrapper" style="min-height: 946px;">
    <!-- <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Free Students
        </h1>
    </section> -->
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <!-- <i class="fa fa-search"></i> -->Free Students</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="">
                            <div class="col-md-12">
                                <form role="form" action="<?php echo site_url( 'student/free_students' ) ?>" method="post" class="form-horizontal">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <!-- <h3 class="box-title">Free Students</h3> -->
                    </div>

                    <div class="box-body no-padding">
                        <?php if ( empty( $students ) ): ?>
                            <p class="bold text-center text-danger">No free students found within this range.</p>
                        <?php else: ?>
                            <div class="table-responsive">
                                <table class="table table-bordered" id="free_students">
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr <?= $student['struck_off']==1?'style="color:red;"':''?> >
                                                <td><?= $key+1 ?></td>
                                                <td class="text-center"><?php echo date('d-m-Y',strtotime($student['created_at'])); ?></td>
                                                ...
                                                <td>
                                                    <a class="table_link" href="<?= site_url( "family/children/{$student['id']}" ) ?>" <?= $student['struck_off']==1?'style="color:red;"':''?> >
                                                        <?= $student['father_name'] ?>
                                                    </a>
                                                </td>
