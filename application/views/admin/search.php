                ...
                if ( isset( $resultlist ) ) {
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#tab_1" data-toggle="tab" aria-expanded="true"><i class="fa fa-list"></i> <?php echo $this->lang->line( 'student_lists' ); ?>
                                </a></li>
                            <li class="">
                                <a href="#tab_2" data-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line( 'detailed_view' ); ?>
                                </a></li>
                        </ul>
                                        ...
                                        if ( empty( $resultlist ) ) {
                                            ...
                                            foreach ( $resultlist as $student ) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= site_url( "family/children" . $student['id'] ) ?>">
                                                            <?= $student['father_name'] ?>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td class="pull-right">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>fee_management/receive_fee/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Collect Fee">
                                                            <i class="fa fa-money"></i>
                                                        </a>

                                                        <a href="<?php echo base_url(); ?>fee_management/fee_voucher?student_id=<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Fee Voucher">
