                    ...
                    <div class="box box-primary">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix">
                                <?php 
                                    echo $examlist['name']." ".$this->lang->line('fill_mark')." (".$class_sections['class']['class']."/".$class_sections['section']['section'].")";
                                ?>
                            </h3>
...
<th>Total</th>
                                                    ...
                                                    if (!empty($student['exam_array'])) {                                                      
                                                        foreach ($student['exam_array'] as $key => $exam_schedule) {
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="exam_schedule[]" value="<?= $exam_schedule['exam_schedule_id'] ?>">

                                                                <div class="form-group">
                                                                    <div class="checkbox">
                                                                        <label><input type="checkbox" name="student_absent<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="ABS" <?php if ($exam_schedule['attendence'] == "ABS") echo "checked"; ?>>Absent</label>
                                                                    </div>
  ...
  foreach($student['exam_array'] as $key => $exam_schedule){
     ...
     $result += ($exam_schedule['get_marks']); 
   
 }?>
 
 
   <input type="text" name="total<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" class="form-control input-sm" id="subject_<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="<?php echo $result ?>" placeholder="Enter Marks" >
