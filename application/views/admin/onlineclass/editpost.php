        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/onlineclass/edit/'.$editpost['id']) ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
