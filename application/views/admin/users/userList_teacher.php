            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>admin/users/teacherList" data-toggle="tab">Teachers</a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>admin/users" data-toggle="tab">Parents</a></li>
                        <!-- <li ><a href="#tab_students" data-toggle="tab">Students</a></li> -->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane  table-responsive" id="tab_parent">
                            <table class="table  table-striped   table-bordered table-hover example2" cellspacing="0"
                                   width="100%">
                                <thead>
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                    <div class="material-switch pull-right">
                                                        ...
                                                        <input id="parent<?php echo $parent->id ?>"
                                                               name="someSwitchOption001" type="checkbox" class="chk"
                                                               data-rowid="<?php echo $parent->id ?>"
                                                               value="checked" <?php if ($parent->is_active == "yes") echo "checked='checked'"; ?> />
                                                        <label for="parent<?php echo $parent->id ?>"
                        ...
                        <div class="tab-pane active table-responsive" id="tab_teacher">
                            ...
                            <table id="user_table" class="table   table-bordered table-hover" width="100%">
                                ...
                                <tr>
                                    <td colspan="5" class="text-right">
                                        <button  onclick="printDiv('tab_teacher')" class="btn d-print-none btn-sm btn-primary"><span class="fa fa-print"></span>
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <!--                                        <th>-->
                                    <?php //echo $this->lang->line('date_of_birth'); ?><!--</th>-->
                                    <!--                                        <th>-->
                                    <?php //echo $this->lang->line('phone'); ?><!--</th>-->
                                    <th>Username</th>
                                    <th>Password</th>
                                    ...
                                    foreach ($teacherList as $teacher) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a
                                                        href="<?php echo base_url(); ?>admin/teacher/view/<?php echo $teacher['id']; ?>"><?php echo $teacher['name'] ?></a>
                                            </td>
                                            <td class="mailbox-name"> <?php echo $teacher['designation'] ?></td>
                                            <!--                                                <td class="mailbox-name"> -->
                                            <?php //echo $teacher['email'] ?><!--</td>-->
                                            <!--                                                <td class="mailbox-name"> -->
                                            <?php //echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($teacher['dob'])); ?><!--</td>-->
                                            <!--                                                <td class="mailbox-name"> -->
                                            <?php //echo $teacher['phone'] ?><!--</td>-->
                                            <td class="mailbox-name"> <?php echo $teacher['username'] ?></td>
                                            <td class="mailbox-name"> <?php echo $teacher['user_tbl_password'] ?></td>

                                            <td class="pull-right">
                                                <div class="material-switch pull-right">

                                                    <input id="teacher<?php echo $teacher['user_tbl_id'] ?>"
                                                           name="someSwitchOption001" type="checkbox" class="chk"
                                                           data-rowid="<?php echo $teacher['user_tbl_id'] ?>"
                                                           value="checked" <?php if ($teacher['user_tbl_active'] == "yes") echo "checked='checked'"; ?> />
                                                    <label for="teacher<?php echo $teacher['user_tbl_id'] ?>"
                                                           class="label-success"></label>
                                                </div>
                        ...
                        <!-- <div class="tab-pane table-responsive" id="tab_accountant">
                            <table class="table     table-bordered table-hover example4" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                        ...
                        <!-- <div class="tab-pane table-responsive" id="tab_librarian">
                            <table class="table     table-bordered table-hover example5" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
