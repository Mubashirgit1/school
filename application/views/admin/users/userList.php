            ...
            <div class="col-md-12">            
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li ><a href="<?php echo base_url(); ?>admin/users/teacherList" >Teachers</a></li>
                        <li class="active"><a href="<?php echo base_url(); ?>admin/users" >Parents</a></li>                        
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane table-responsive" id="tab_teacher">
                            <table class="table     table-bordered table-hover example3" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
