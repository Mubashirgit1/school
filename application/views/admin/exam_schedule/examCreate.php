    ...
    ?>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                <?php 
                                    echo $examlist['name']." ".$this->lang->line('exam_schedule')." (".$class_sections['class']['class']."/".$class_sections['section']['section'].")"; 
                                ?>
                            </h3>
                            <div class="pull-right">
                                <a href="<?php echo site_url('admin/exam?exam_id=').$exam_id ?>" class="btn btn-info btn-sm" style="padding: 4px 10px;">Back</a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fmark_<?php echo $value['id'] ?>" class="form-control" disabled id="fmark_<?php echo $value['id'] ?>" value="<?php echo $value['max_marks'] ?>" placeholder="Enter Full Marks">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">

                                                            <input type="text" name="pmarks_<?php echo $value['id'] ?>" class="form-control" disabled id="pmarks_<?php echo $value['id'] ?>" value="<?php echo $value['passing_marks'] ?>" placeholder="Enter Passing Marks">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
