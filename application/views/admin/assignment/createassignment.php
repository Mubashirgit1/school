        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/assignment/createassignment') ?>"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="content_title" name="content_title" placeholder="" type="text"
                                       class="form-control" required value="<?php echo set_value('content_title'); ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <input id="marks" name="marks" placeholder="" type="text" class="form-control" required
                                       value="<?php echo set_value('marks'); ?>"/>
                                <span class="text-danger"><?php echo form_error('marks'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Passing Marks</label>
                                <input id="passing_marks" name="passing_marks" placeholder="" type="text"
                                       class="form-control" required value="<?php echo set_value('passing_marks'); ?>"/>
