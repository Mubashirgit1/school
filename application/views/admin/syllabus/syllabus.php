        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/content/createsyllabus') ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Syllabus Date</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="syllabus" name="syllabus" required  placeholder="" rows="5" placeholder="Enter syllabus..."><?php echo set_value('syllabus'); ?></textarea>
            ...
            <div class="col-md-8">               
                <?php $this->load->view("admin/syllabus/list"); ?>
            </div>
        </div>
        <div class="row">           
            <div class="col-md-12">
