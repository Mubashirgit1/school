        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/syllabus/edit/'.$editpost['id']) ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select  id="teacher_id" name="teacher_id" class="form-control" required  >
                                    ...
                                    foreach ($teacherlist as $teacher) {
                                        ?>
                                        <option value="<?php echo $teacher['id'] ?>" <?php if ( $teacher['id'] == $editpost['teacher_id']) echo "selected=selected" ?>><?php echo $teacher['name'] ?></option>
                                        <?php
                                        $count++;
                                    }
                                    ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="syllabus" name="syllabus" required  placeholder="" rows="5" placeholder="Enter syllabus..."><?php echo strip_tags($editpost['syllabus'])  ?></textarea>
