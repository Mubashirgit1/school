                        ...
                        <tr>
                            ...
                            <td class="mailbox-name">
                                ...
                                if ($data['syllabus'] == "") {
                                    ...
                                    <pre><?php echo $data['syllabus']; ?></pre></p>
                                    <?php
                                }
                                ?>
                            ...
                            <td class="mailbox-name"><a target="blank"
                                                        href="<?php echo base_url(); ?><?php echo $data['file'] ?>"
                                                        class="btn btn-default btn-xs" data-toggle="tooltip"
                                                        title="<?php echo $this->lang->line('view'); ?>">
                                    <i class="fa fa-eye"></i>
                                </a></td>
                            <td class="mailbox-name"><a download
                                                        href="<?php echo base_url(); ?><?php echo $data['file'] ?>"
                                                        class="btn btn-default btn-xs" data-toggle="tooltip"
                            ...
                            <td class="mailbox-date pull-right">
                                <a href="<?php echo base_url(); ?>admin/content/syllabusedit/<?php echo $data['id'] ?>"
                                   class="btn btn-default btn-xs" data-toggle="tooltip"
                                   title="<?php echo $this->lang->line('edit'); ?>">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <a href="<?php echo base_url(); ?>admin/content/syllabusdelete/<?php echo $data['id'] ?>"
                                   class="btn btn-default btn-xs" data-toggle="tooltip"
