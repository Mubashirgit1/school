...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('backend/dist/css/font-awesome.min.css') ?>">
        ...
        <script src="<?= base_url( 'backend/bootstrap/js/jquery.min.js' ) ?>"></script>
    </head>
        ...
        <!-- <div class="logo_container">
            <div class="container-fluid">
                <div class="logo_container_inner">
                    <a href="< ?= site_url() ?>"><img src="< ?= site_url( 'backend/images/plugedin-logo.png' ) ?>" alt="Plugedin" width="150" height="15"></a>
                </div>
            </div>
        </div> -->
                ...
                <div class="menu_container_inner">
                    ...
                    <!-- <ul class="menu_container_inner_left">
                        ...
                        <li>
                            ...
                            <!--                        <li>-->
                            <!--                            <a href="--><?//= site_url('site/login') ?><!--">Demo</a>-->
                            <!--                        </li>-->
                            <!--                    </ul>-->
