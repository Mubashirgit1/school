                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-user">
                                            <li>
                                                <a href="<?php echo base_url(); ?>librarian/librarian/changepass"><i class="fa fa-key"></i> <?php echo $this->lang->line( 'change_password' ); ?>
                                                </a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                ...
                <button type="submit" name="search" id="search-btn" style="padding: 3px 12px !important;border-radius: 0px 30px 30px 0px; background: #fff;" class="btn btn-flat"><i class="fa fa-search"></i></button>
                    ...
                    <ul class="sidebar-menu">
                        <li class="<?php echo set_Topmenu( 'dashboard' ); ?>">
                            <a href="<?php echo base_url(); ?>librarian/librarian/dashboard"><i class="fa fa-user-secret"></i> <?php echo $this->lang->line( 'my_profile' ); ?>
                            </a></li>

                        <li class="treeview <?php echo set_Topmenu( 'Library' ); ?>">
                            <a href="#">
                                <i class="fa fa-book"></i> <span><?php echo $this->lang->line( 'books' ); ?></span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">

                                <li class="<?php echo set_Submenu( 'book/index' ); ?>">
                                    <a href="<?php echo base_url(); ?>librarian/book"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line( 'add_book' ); ?>
                                    </a></li>
                                <li class="<?php echo set_Submenu( 'book/getall' ); ?>">
                                    <a href="<?php echo base_url(); ?>librarian/book/getall"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line( 'book_list' ); ?>
                                    </a></li>
                            </ul>
                        ...
                        <li class="treeview <?php echo set_Topmenu( 'Member' ); ?>">
                            <a href="#">
                                ...
                                <span><?php echo $this->lang->line( 'issue_return' ); ?></span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?php echo set_Submenu( 'member/index' ); ?>">
                                    <a href="<?php echo base_url(); ?>librarian/member"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line( 'books_issue_return' ); ?>
                                    </a></li>
                                <li class="<?php echo set_Submenu( 'student/search' ); ?>">
                                    <a href="<?php echo base_url(); ?>librarian/student/search"><i class="fa fa-angle-double-right"></i>Add Student</a>
                                </li>
                                <li class="<?php echo set_Submenu( 'teacher/index' ); ?>">
                                    <a href="<?php echo base_url(); ?>librarian/teacher"><i class="fa fa-angle-double-right"></i>Add Teacher</a>
                                </li>
