...
<div class="content-wrapper">
    <section class="content-header">
        <h4>
            <?php echo $this->lang->line('notice_board'); ?></small>
        </h4>
    </section>
    <!-- Main content -->
                            ...
                            <?php if (empty($notificationlist)) {
                                ...
                                foreach ($notificationlist as $key => $notification) {
                                    ...
                                    <div class="panel box box-primary">
                                        <div class="box-header with-border">
                                            <h4 class="box-title">
                                                <a data-toggle="collapse" class="notification_msg text-black" data-msgid="<?php echo $notification['id']; ?>" data-parent="#accordion" href="#collapse<?php echo $notification['id']; ?>" aria-expanded="false" class="collapsed">
