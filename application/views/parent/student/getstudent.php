            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    ...
                    <?php  $url = $student['image'] != null ? $student['image'] : '/uploads/student_images/no_image.png';  ?>
                        ...
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url() . $url ?>" alt="User profile picture">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li style='visibility:hidden' class=""><a href="#fee" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('fees'); ?></a></li>
                        <li style='visibility:hidden' class=""><a href="#exam" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('exam'); ?></a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="activity">  
                            ...
                            <table class="table     table-bordered table-hover example2"><tbody>
                                    <tr>
                                ...
                                foreach ($examSchedule as $key => $value) {
                                    ...
                                    if (empty($value['exam_result'])) {
                                        ...
                                        <div class="table-responsive"> 
                                            <table class="table     table-bordered table-hover example display">
                                                <thead>
                                                    <tr>
                                                        <th>
