    ...
    <section class="content">
        ...
        <div class="box-body">
            ...
            foreach($vocation as $key => $sylla ){
                if($i == 1){
                ?>
                <div id="<?=  $i?>" class="tab-pane fade in active "><br>
                <?php }else{ ?>
                <div id="<?=  $i?>" class="tab-pane fade"><br>
                <?php }?>
                <p>  </p>
    
                <div class="row"><div class="col-sm-4"> <h4> Title:  Vacation/Notes</h4>  </div> <div class="col-sm-4"><h4 > Class :<?= $sylla[0]["class"]." / ".$sylla[0]["section_name"] ?> </h4></div> <div class="col-sm-4"><h4 > Teacher : <?= $sylla[0]["teacher"]?></h4></div></div>
