...
class Section_model extends CI_Model {
    ...
    public function getTeacherClassBySection($classid, $teacher_id) {
        $this->db->select('class_sections.id,class_sections.section_id,sections.section');
        $this->db->from('class_sections');
        $this->db->join('sections', 'sections.id = class_sections.section_id');
    ...
    public function getTeacherClass($teacher_id) {
        $this->db->select('class_sections.id,class_sections.class_id,classes.class');
        $this->db->from('class_sections');
    ...
    {
        $query = $this->db->select( 'student_id' )->where( 'class_id', $class_id )->get( 'student_session' );
        //$query = $this->db->select('student_id')->from('student_session')->get();
