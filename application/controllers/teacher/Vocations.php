...
class Vocations extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('teacher/vocation/createvocation', $data);
    ...
    function edit($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['list']       = $list;
            $this->load->view('layout/teacher/header');
            $this->load->view('teacher/vocation/editpost', $data);
            $this->load->view('layout/teacher/footer');
        } else {
            ...
            redirect('teacher/vocations/index');
        }
    }
